...
def _scrape_series(url_string):
    ...
    result = {"hasTitle": title, "hasDOI": doi, "hasAuthor": authors, "hasPublicationYear": date, "hasURL": url}
    print 'SERIES'
    return result
...
def _scrape_statistica2(url_string2):
 ...
 #   dataCitation = my_page.xpath("//*[@id='articleCitations']/div/p/text()")[0].split_before(').')[0]
    ...
    url = url_string2
    result = {"authorCitation": authorC ,"titleCitation": articleC}
    my_data += zip(authorC,articleC)
    citat += citation
    #print citat
    #print result 
    print 'STATISTICAAAAA'
    return my_data #se metti 'result' sono divisi in gruppi
...
def _scrape_dlib2(url_string2):
    ...
    url = url_string2
    result = { "authorCitation": authorCitation ,"titleCitation": titleCitation, "doiCitation" : doiCitation}
